  ...
  (setq-default
   ...
   '(;; ----------------------------------------------------------------
     ...
     (c-c++ :variables
            ...
            c-c++-backend 'lsp-clangd ; Install clang beforehand.
            c-c++-default-mode-for-headers 'c++-mode
   ...
   dotspacemacs-additional-packages '(fira-code-mode solaire-mode try)

   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()

   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(vi-tilde-fringe window-purpose)
